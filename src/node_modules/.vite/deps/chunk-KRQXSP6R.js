import {
  Node
} from "./chunk-RJ6NX6TL.js";
import {
  PointerEventTypes,
  PointerInfo,
  PointerInfoPre
} from "./chunk-FWVBETKR.js";
import {
  UniformBuffer,
  UniqueIdGenerator
} from "./chunk-TCDC67T5.js";
import {
...
import {
  Texture
} from "./chunk-VPT7QL3A.js";
import {
  SerializationHelper,
  Tags
} from "./chunk-OC4LPATT.js";
import {
  __decorate,
  expandToProperty,
  serialize,
...
import {
  ...
  Vector3,
  _ObserveArray
} from "./chunk-X764TGST.js";
import {
  DrawWrapper,
  EffectWrapper,
  Viewport
} from "./chunk-CFWTBSB6.js";
import {
  VertexBuffer
} from "./chunk-VMQALS5J.js";
import {
  Tools
} from "./chunk-QFCL7VW7.js";
import {
  LoadFile,
  ReadFile,
  RequestFile
} from "./chunk-PN2XQ3AE.js";
import {
  GetClass,
  RegisterClass
...
var ThinBlurPostProcess = class _ThinBlurPostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      ...
      list.push(Promise.all([import("./kernelBlur.fragment-ETXHHLLV.js"), import("./kernelBlur.vertex-ZPC6BOOB.js")]));
    } else {
...
var ShadowGenerator = class _ShadowGenerator {
  ...
  async _initShaderSourceAsync(forceGLSL = false) {
    ...
    if (engine.isWebGPU && !forceGLSL && !_ShadowGenerator.ForceGLSL) {
      ...
      await Promise.all([
        import("./shadowMap.fragment-HPYEZH3O.js"),
        import("./shadowMap.vertex-3UAEFCQ5.js"),
        import("./depthBoxBlur.fragment-MICXO4HX.js"),
        import("./shadowMapFragmentSoftTransparentShadow-4ZHI7QFE.js")
      ]);
    } else {
      await Promise.all([
        import("./shadowMap.fragment-DS3NIQMK.js"),
        import("./shadowMap.vertex-5C362EBL.js"),
...
var DepthRenderer = class _DepthRenderer {
  ...
  async _initShaderSourceAsync(forceGLSL = false) {
    ...
    if (engine.isWebGPU && !forceGLSL && !_DepthRenderer.ForceGLSL) {
      this._shaderLanguage = 1;
      await Promise.all([import("./depth.vertex-JHIAOHH4.js"), import("./depth.fragment-NYIOIRWM.js")]);
    } else {
      await Promise.all([import("./depth.vertex-H3NEZZOE.js"), import("./depth.fragment-UELHVAWB.js")]);
    }
    this._shadersLoaded = true;
  }
  /**
...
//# sourceMappingURL=chunk-KRQXSP6R.js.map
