...
function Twofa() {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        if (!code || code.length < 6) {
            setError('code required or incomplete');
            return;
        }
        ...
        fetch('http://localhost:3000/twofa/verify', {
            method: 'POST',
        ...
        <div className="relative min-h-screen bg-gradient-to-r from-cyan-500/50 to-blue-500/50 text-white flex flex-col items-center justify-center space-y-12 p-10">
            ...
            <div className="flex min-h-screen items-center justify-center ">
                <form onSubmit={handleSubmit} className="bg-gradient-to-r from-[#45586c] to-[#424048] p-8 rounded-lg shadow-xl shadow-cyan-500/30 w-80">
                    ...
                    <div className="mb-4">
                        <input type="code" value={code} onChange={(e) => setCode(e.target.value)} className="w-full border text-gray-500 order-[#E95D2C] rounded-lg p-2 focus:outline-none focus:text-[#B0CEE2] focus:ring-2 focus:ring-[#B0CEE2]" placeholder="code"/>
                    </div>
